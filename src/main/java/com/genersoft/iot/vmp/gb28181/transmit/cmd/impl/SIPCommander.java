...
public class SIPCommander implements ISIPCommander {
    ...
    public void playStreamCmd(MediaServerItem mediaServerItem, SSRCInfo ssrcInfo, Device device, String channelId, ZLMHttpHookSubscribe.Event event, SipSubscribe.Event errorEvent) {
        ...
        try {
            ...
            // 添加流变动回调
			addStreamChangeHook(event, subscribeKey);

            StringBuilder content = getInvitePlayContent(mediaServerItem, ssrcInfo, streamMode);
            ...
            transmitRequest(device, request, (e -> {
            	...
            	// 成功
                streamSession.put(device.getDeviceId(), channelId, ssrcInfo.getSsrc(), streamId, mediaServerItem.getId(), e.getClientTransaction());
	...
	private void addStreamChangeHook(ZLMHttpHookSubscribe.Event event, JSONObject subscribeKey) {
     ...
     */
    @NotNull
    private StringBuilder getInvitePlayContent(MediaServerItem mediaServerItem, SSRCInfo ssrcInfo, String streamMode) {
        ...
        addPlayContent(ssrcInfo, streamMode, content);
        return content;
    }

    private void addPlayContent(SSRCInfo ssrcInfo, String streamMode, StringBuilder content) {
